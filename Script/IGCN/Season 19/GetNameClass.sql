...
BEGIN
    ...
    SELECT @NameClass = 
		...
		WHEN Class = 15 THEN 'Darkness Wizard'
		...
		WHEN Class = 143 THEN 'Infinity Rune Wizard'
		...
		WHEN Class = 159 THEN 'Rogue Slayer'
		...
		WHEN Class = 175 THEN 'Magnus Gun Crusher'
